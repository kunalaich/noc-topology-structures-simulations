...
void Flit::copy(const Flit& other)
{
    ...
    this->pktLen_var = other.pktLen_var;
...
int Flit::getPktLen() const
{
    return pktLen_var;
}

void Flit::setPktLen(int pktLen)
{
    this->pktLen_var = pktLen;
}
...
int FlitDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='p' && strcmp(fieldName, "pktLen")==0) return base+3;
    if (fieldName[0]=='f' && strcmp(fieldName, "flitSize")==0) return base+4;
    if (fieldName[0]=='t' && strcmp(fieldName, "type")==0) return base+5;
    if (fieldName[0]=='V' && strcmp(fieldName, "Vc")==0) return base+6;
    if (fieldName[0]=='p' && strcmp(fieldName, "pcktId")==0) return base+7;
    if (fieldName[0]=='f' && strcmp(fieldName, "flits")==0) return base+8;
    if (fieldName[0]=='f' && strcmp(fieldName, "flitIdx")==0) return base+9;
    if (fieldName[0]=='s' && strcmp(fieldName, "srcId")==0) return base+10;
    if (fieldName[0]=='d' && strcmp(fieldName, "destId")==0) return base+11;
    if (fieldName[0]=='o' && strcmp(fieldName, "op")==0) return base+12;
    if (fieldName[0]=='p' && strcmp(fieldName, "pre_r")==0) return base+13;
    if (fieldName[0]=='f' && strcmp(fieldName, "firstNet")==0) return base+14;
    if (fieldName[0]=='I' && strcmp(fieldName, "InjectTime")==0) return base+15;
    if (fieldName[0]=='F' && strcmp(fieldName, "FirstNetTime")==0) return base+16;
...
std::string FlitDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return long2string(pp->getPktLen());
        case 4: return long2string(pp->getFlitSize());
        case 5: return long2string(pp->getType());
        case 6: return long2string(pp->getVc());
        case 7: return long2string(pp->getPcktId());
        case 8: return long2string(pp->getFlits());
        case 9: return long2string(pp->getFlitIdx());
        case 10: return long2string(pp->getSrcId());
        case 11: return long2string(pp->getDestId());
        case 12: return long2string(pp->getOp());
        case 13: return long2string(pp->getPre_r());
        case 14: return bool2string(pp->getFirstNet());
        case 15: return double2string(pp->getInjectTime());
        case 16: return double2string(pp->getFirstNetTime());
        default: return "";
    }
}
...
bool FlitDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setPktLen(string2long(value)); return true;
        case 4: pp->setFlitSize(string2long(value)); return true;
        case 5: pp->setType(string2long(value)); return true;
        case 6: pp->setVc(string2long(value)); return true;
        case 7: pp->setPcktId(string2long(value)); return true;
        case 8: pp->setFlits(string2long(value)); return true;
        case 9: pp->setFlitIdx(string2long(value)); return true;
        case 10: pp->setSrcId(string2long(value)); return true;
        case 11: pp->setDestId(string2long(value)); return true;
        case 12: pp->setOp(string2long(value)); return true;
        case 13: pp->setPre_r(string2long(value)); return true;
        case 14: pp->setFirstNet(string2bool(value)); return true;
        case 15: pp->setInjectTime(string2double(value)); return true;
        case 16: pp->setFirstNetTime(string2double(value)); return true;
